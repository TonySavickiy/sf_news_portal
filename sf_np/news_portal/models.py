...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        for i in range(len(rate_comment_post)):
            a = a + rate_comment_post[i]['rating']
...
class Post(models.Model):
    author= models.ForeignKey(Author, on_delete=models.CASCADE) #Поле 1 ко многим с таблицей Автор
    ...
    categoryType=models.CharField(max_length=2, choices=CATEGORY_CHOICES,default=article) #Поле категории(с возможностью выбрать из 2х вариантов)
